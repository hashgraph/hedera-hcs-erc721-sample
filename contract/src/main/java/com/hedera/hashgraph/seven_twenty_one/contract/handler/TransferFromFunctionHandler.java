...
public final class TransferFromFunctionHandler
    ...
    public void validate(
        ...
        @Var
        var isAuthorized = Objects.equals(tokenOwner, caller);
        if (!isAuthorized) isAuthorized =
            state.isApproved(caller, arguments.id);
        if (!isAuthorized) isAuthorized =
        ...
        // iv. TokenOwners[id] = from
            ...
            Objects.equals(tokenOwner, arguments.from),
            Status.TRANSFER_FROM_NOT_TOKEN_OWNER
        );
